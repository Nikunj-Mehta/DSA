...
public class MergeSort {
    public static void mergeSort(int[] arr) {
        ...
        // divide the remaining array into smaller parts until base case is reached
        mergeSort(helper1);
        mergeSort(helper2);

        // now use the code of Merge two sorted arrays and merge helper1 and helper2 into arr.
        merge(helper1, helper2, arr);
//        helper1 = null; // This is done to reduce the SC form O(n*log n) to O(n)
//        helper2 = null; // Delete the array after they are merged.
    ...
    public static void main(String[] args) {
        ...
        print(arr);
        mergeSort(arr); // TC = O(n*log n) SC = O(n*log n) we can make SC = O(n) by setting extra arrays to null after they are merged
        print(arr);
    }
}
